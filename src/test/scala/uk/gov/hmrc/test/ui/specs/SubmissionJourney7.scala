...
class SubmissionJourney7 extends BaseSpec with BeforeAndAfter {
  ...
  before {
    ...
    calculationData.submitCalculation("calculationDataSet7")
  ...
  Feature("Business scenario AA journeys") {
    ...
    Scenario(s"Calculate Business Journey1", ZapTests) {
      ...
      ContactNumberPage.verifyPageEnterContactNumberAndContinue("090909")
      ...
      TaxReliefAmountPage.verifyPageEnterTaxReliefAndContinue("1000000000000")
