...
import uk.gov.hmrc.test.ui.functions.{CommonCalculationAAandLTADecreaseCharge, CommonCalculationAAandLTAZeroCharge}
...
class EndToEndAAAndLTAJourneyTest7 extends BaseSpec with BeforeAndAfter {
  ...
  before {
    ...
    val commonCalculationAAAndLTA                = new CommonCalculationAAandLTADecreaseCharge()
