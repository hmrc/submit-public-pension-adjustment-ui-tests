...
class SubmissionJourney6 extends BaseSpec with BeforeAndAfter {
  ...
  before {
    ...
    calculationData.submitCalculation("calculationDataSet6")
  ...
  Feature("Business scenario AA journeys") {
    ...
    Scenario(s"Calculate Business Journey1", ZapTests) {
      ...
      TaxReliefAmountPage.verifyPageEnterTaxReliefAndContinue("33333")
